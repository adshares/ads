...
//LESZEK
static void
ed25519_hram2(hash_512bits hram, const ed25519_signature RS, const ed25519_public_key pk, const unsigned char *m, size_t mlen, const unsigned char *m2, size_t mlen2) {
	ed25519_hash_context ctx;
	ed25519_hash_init(&ctx);
	ed25519_hash_update(&ctx, RS, 32);
	ed25519_hash_update(&ctx, pk, 32);
	ed25519_hash_update(&ctx, m, mlen);
	ed25519_hash_update(&ctx, m2, mlen2);
	ed25519_hash_final(&ctx, hram);
}
...
//LESZEK
void
ED25519_FN(ed25519_sign2) (const unsigned char *m, size_t mlen, const unsigned char *m2, size_t mlen2, const ed25519_secret_key sk, const ed25519_public_key pk, ed25519_signature RS) {
	ed25519_hash_context ctx;
	bignum256modm r, S, a;
	ge25519 ALIGN(16) R;
	hash_512bits extsk, hashr, hram;
	...
	/* S = H(R,A,m).. */
	ed25519_hram2(hram, RS, pk, m, mlen, m2, mlen2);
	expand256_modm(S, hram, 64);
...
//LESZEK
int
ED25519_FN(ed25519_sign_open2) (const unsigned char *m, size_t mlen, const unsigned char *m2, size_t mlen2, const ed25519_public_key pk, const ed25519_signature RS) {
	ge25519 ALIGN(16) R, A;
	hash_512bits hash;
	bignum256modm hram, S;
	unsigned char checkR[32];
