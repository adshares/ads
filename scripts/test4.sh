...
cd ${userpath[4]}
echo '{"run":"get_account","address":"0002-00000001-XXXX"}' | esc
echo '{"run":"get_account","address":"0003-00000000-XXXX"}' | esc
cd ..

for i in `seq 1 360000`
do
        echo $i
        sendCash ${userpath[4]} "0003-00000000-XXXX" 0.0001
#        sleep 1
done
