...
//#define BANK_MIN_MASS    (0x100000000)
//#define BANK_MIN_WEIGHT  (0x1000000000)
...
#define BANK_USER_FEE(x) (0x1000 + ((BANK_PROFIT((x)*TXS_DIV_FEE/BLOCKDIV))>>2)) /* collected every block */
